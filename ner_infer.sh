...
python run_ner.py --do_train=false --do_eval=false --do_predict=true --vocab_file=$BIOBERT_DIR/vocab.txt --bert_config_file=$BIOBERT_DIR/bert_config.json --init_checkpoint=$OUTPUT_DIR/model.ckpt-1425 --data_dir=$NER_DIR --output_dir=$OUTPUT_DIR
